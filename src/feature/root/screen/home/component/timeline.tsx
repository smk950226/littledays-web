        ...
        >
            ...
            <Box
                sx={{
                    ...
                    px: '5%',
                    overflow: 'visible',
                    pt: { mobile: '20px', tablet: '40px', laptop: '60px' },
            ...
            >
                <Box
                    sx={{
                        ...
                        gap: { mobile: '90px', tablet: '2rem', laptop: '6rem' },
                        alignItems: {
                            mobile: 'flex-start',
                            tablet: 'center',
                            laptop: 'center',
                ...
                >
                    ...
                    >
                        ...
                        {IMAGES.slice(6).map((img, j) => {
                            ...
                            const translateYLaptop = isVisible
                                ? (activeIdx - i) * step
                                : -step;
                            const translateYMobile = isVisible
                                ? (activeIdx - i) * step
                                : step;
                            return (
                                <Box
                                    ...
                                    sx={{
                                        ...
                                        transform: {
                                            mobile: `translateY(${translateYMobile}px)`,
                                            tablet: `translateY(calc(-50% + ${translateYLaptop}px))`,
                                            laptop: `translateY(${translateYLaptop}px)`,
                                        },
                                        transition:
