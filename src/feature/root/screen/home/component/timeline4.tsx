...
export default function Timeline4Section() {
    ...
    useEffect(() => {
        ...
        const advance = () => {
            if (!playing) return;
            idx = idx + 1;
            if (idx >= totalStates) idx = 0; // 끝까지 재생되면 처음부터 자동 반복
            setActiveIdx(idx);
                                ...
                                transform:
                                    activeIdx >= IMAGES.length
                                        ? {
                                              ...
                                              laptop: 'translateY(-50%)',
                                          }
                                        : {
                                              mobile: 'translateY(calc(-50% + 80px))',
                                              tablet: 'translateY(calc(-50% + 80px))',
                                              laptop: 'translateY(calc(-50% + 80px))',
                                          },
                                transition:
                                    'opacity 0.5s ease, transform 0.5s ease',
                                willChange: 'opacity, transform',
