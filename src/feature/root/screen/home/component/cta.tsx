...
export default function CtaSection() {
    ...
    return (
        <Box
            ...
            sx={{
                background: '#fff',
                pt: { mobile: 0, tablet: 0, laptop: '30px' },
                pb: 0,
                px: '5%',
                textAlign: 'center',
            }}
        >
            <Box
                sx={{
                    ...
                    py: { mobile: '52px', tablet: '64px', laptop: '80px' },
                    px: { mobile: '24px', tablet: '40px', laptop: '60px' },
                    textAlign: 'center',
                }}
            >
                <Box
                    ...
                    sx={{
                        ...
                        height: { mobile: '60px', laptop: '80px' },
                        mb: '32px',
                        borderRadius: '20px',
                ...
                <Box
                    ...
                    sx={{
                        ...
                        fontWeight: 400,
                        lineHeight: { mobile: '22px', tablet: '26px' },
