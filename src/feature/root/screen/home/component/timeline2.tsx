                        ...
                        {IMAGES.map((img, i) => (
                            <Box
                                ...
                                sx={{
                                    ...
                                    height: 'auto',
                                    backgroundColor: { mobile: '#fff', tablet: 'transparent', laptop: 'transparent' },
                                    borderRadius: { mobile: '16px', tablet: '20px', laptop: '20px' },
                                    boxShadow: { mobile: '0 8px 24px rgba(0,0,0,0.10)', tablet: 'none', laptop: 'none' },
                                    px: { mobile: '10px', tablet: 0, laptop: 0 },
                                    py: { mobile: '16px', tablet: 0, laptop: 0 },
