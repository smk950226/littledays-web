        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        {IMAGES.map((img, i) => {
                            const hasBox = i < 5; // 이미지 1~5: 모바일에서만 흰 박스 배경(라운드 16px·그림자·여백)
                            return (
                                <Box
                                    key={i}
                                    component="img"
