    ...
    return (
        ...
        >
            <Box sx={{
                ...
                pt: { mobile: '120px', laptop: 0 }, pb: { mobile: '110px', laptop: 0 },
            }}>
                <Box sx={{ maxWidth: '1140px', mx: 'auto', width: '100%', display: 'flex', flexDirection: { mobile: 'column', tablet: 'row', laptop: 'row' }, gap: { mobile: '90px', tablet: '2rem', laptop: '6rem' }, alignItems: 'flex-start', pt: { mobile: 0, laptop: '210px' } }}>
                    ...
                    <Box sx={{ flex: 1, minWidth: 0, width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'flex-start', position: 'relative', height: { laptop: 'calc(100vh - 200px)' }, minHeight: { mobile: maxImgHeight > 0 ? `${maxImgHeight}px` : '100vw', laptop: 'unset' }, mt: { mobile: 0, laptop: '-40px' } }}>
                        {IMAGES.map((img, i) => (
                            <Box
                                key={i}
                                component="img"
